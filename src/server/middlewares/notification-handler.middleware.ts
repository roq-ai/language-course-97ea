...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'CourseCreated.create': { roles: ['administrator', 'teacher'], key: 'courseId', tenantPath: [], userPath: [] },
  'AssignmentUpdated.update': {
    roles: ['administrator', 'teacher', 'student'],
    key: 'assignmentId',
    tenantPath: [],
    userPath: [],
  },
  'GradeDeleted.delete': { roles: ['administrator', 'teacher'], key: 'gradeId', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['administrator'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['administrator', 'teacher', 'student'];
